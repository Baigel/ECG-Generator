...
#define LOG_INIT_COUT() logger _log(std::cout, __PRETTY_FUNCTION__)
#define LOG_INIT_CERR() logger _log(std::cerr, __PRETTY_FUNCTION__)
#define LOG_INIT_CLOG() logger _log(std::clog, __PRETTY_FUNCTION__)
#define LOG_INIT_CUSTOM(X) logger _log((X), __PRETTY_FUNCTION__)
